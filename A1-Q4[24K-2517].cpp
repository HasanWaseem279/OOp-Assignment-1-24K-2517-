...
int main()
{
    ...
    cout << "Initializing Bus Stops..." << endl;
    ...
    cout << "Bus Stops initialized successfully." << endl;

    cout << "\nCreating Route 101 and adding stops..." << endl;
    Route route1(101, 7);
    ...
    cout << "Route setup complete." << endl;

    cout << "\nRegistering Student: Hasan..." << endl;
    Student hasan(1, "Hasan");
    hasan.registerTransportation();
    hasan.assignStops(&gulshan, &fastnu);
    cout << "Transportation registered for Hasan." << endl;

    cout << "Paying semester fee for Hasan's transport card..." << endl;
    hasan.getTransportationCard()->paySemesterFee();
    cout << "Payment successful. Transportation card activated." << endl;

    cout << "\nInitializing Bus 501 with capacity of 10 students..." << endl;
    Bus bus1(501, 10);
    bus1.startRoute(&route1);
    cout << "Bus 501 is now at the first stop: " << bus1.getCurrentStop()->getName() << endl;

    cout << "\nStudent Hasan taps his transportation card to board the bus..." << endl;
    bus1.tapCard(hasan.getTransportationCard());
    cout << "Hasan successfully boarded the bus." << endl;

    cout << "\nBus starting its route..." << endl;
    while (bus1.getCurrentStop() != nullptr)
    {
        cout << "Bus is currently at: " << bus1.getCurrentStop()->getName() << endl;
        bus1.moveToNextStop();
    }
    cout << "\nBus has reached the final stop." << endl;
    return 0;
}